export default function SectionHeader() {
  return (
    <div className="text-center mb-20">
      ...
      <h2 id="como-funciona-heading" className="vogue-subhead mb-8" style={{color: '#FEFEFE'}}>COMO FUNCIONA</h2>
      ...
      <p className="vogue-body max-w-3xl mx-auto text-lg" style={{color: '#FEFEFE', opacity: 0.9}}>
        3 passos simples para garantir sua manicure premium com total segurança
      </p>
    </div>
  )
}
